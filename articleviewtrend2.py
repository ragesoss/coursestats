...
baseurl = 'https://wikimedia.org/api/rest_v1/metrics/pageviews/per-article/' + language + '.wikipedia.org/all-access/all-agents/'
...
def articleviews(article, month):
    ...
    firstday = year + month_number + '01'
    lastday = year + month_number + str(days_in_month)
    articleurl = baseurl + urllib.quote(article) + '/daily/' + firstday + '/' + lastday
